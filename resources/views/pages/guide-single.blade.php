    ...
    <div class="container">
        <div class="guide">
            <div class="bread">
                ...
                </a><a href="{{route('main-page')}}"> {{__('main.main')}} <span>></span></a><a href="{{route('guide')}}"> {{__('main.guide')}} <span>></span></a><a href="#"> {{__('guide.title')}}</a>
            </div>
            ...
            <hr>
            <a id="cancel" href="{{route('main-page')}}">{{__('main.back')}}</a>
