...
@section('content')
    ...
    <div class="container">
        <div class="bread">
            ...
            </a><a href="{{route('main-page')}}"> Главная <span>></span></a><a href="{{route('analitick')}}"> Аналитика <span>></span></a><a href="{{route('news')}}"> Новости <span>></span></a><a href="#"> {{$reviews->title}} <span>></span></a>
        </div>
