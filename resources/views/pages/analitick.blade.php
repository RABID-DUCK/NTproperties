...
<div class="container">
    <div class="analitick">
        <div class="bread">
            ...
            </a><a href="{{route('main-page')}}"> {{__('main.main')}} <span>></span></a><a href="#"> {{__('main.analitick')}} <span>></span></a>
        </div>
        <h1>{{__('main.analitick_news_reviews')}}</h1>
        <div class="news">
            <h2>{{__('main.news')}}</h2>
            <div class="list">
        ...
        <a href="{{route('news')}}" class="news_more">{{__('main.all_news')}}</a>
        <hr>
        ...
        <a href="{{route('reviews')}}" class="news_more">{{__('main.all_reviews')}}</a>
    </div>
</div>
@endsection
