...
@section('content')
    ...
    <div class="container">
        <div class="bread">
            ...
            </a><a href="{{route('main-page')}}"> Главная <span>></span></a><a href="{{route('analitick')}}"> Аналитика <span>></span></a><a href="{{route('news')}}"> Новости <span>></span></a><a href="#"> {{\Illuminate\Support\Str::limit($news->title, 30)}} <span>></span></a>
        </div>
