...
@section('content')
    ...
    <div class="container">
        <div class="bread">
            ...
            </a><a href="{{route('main-page')}}"> {{__('main.main')}} <span>></span></a><a href="{{route('analitick')}}"> {{__('main.analitick')}} <span>></span></a><a href="{{route('news')}}"> {{__('main.news')}} <span>></span></a><a href="#"> {{\Illuminate\Support\Str::limit(app()->currentLocale() == 'RU' ? $news->title : $news->eng_title, 30)}} <span>></span></a>
        </div>
                 ...
                 <div class="item">
                    ...
                    <div class="content">
                        <p>
                            ...
                            {!! app()->currentLocale() == 'RU' ? $news->description : $news->eng_description !!}
                        </p>
                    </div>
                 </div>
                 <hr>
                 <a href="{{route('news')}}">{{__('main.back')}}</a>
        </div>
